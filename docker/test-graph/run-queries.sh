...
INFLUENCERS_TEST_FILE="/test-graph/mocks/influencers.cypher"
...
echo "Importing INFLUENCERs test graph..."
time cypher-shell -u neo4j -p 12345678 -f "$INFLUENCERS_TEST_FILE"
