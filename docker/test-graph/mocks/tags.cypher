...
// ##### Posts related tags ######
// ###############################
MERGE (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) SET p.content = "Privacy is a Human Right", p.kind = "short", p.indexed_at = 1719308315917;
MATCH (u:User {id: $peter}), (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) MERGE (u)-[:AUTHORED]->(p);
MATCH (u:User {id: $arst}), (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) MERGE (u)-[:TAGGED {label: $go_post_tag, id: "0RDVNJ0XR560", indexed_at: 1724544095000}]->(p);
MATCH (u:User {id: $nakamoto}), (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) MERGE (u)-[:TAGGED {label: $go_post_tag, id: "S02JBP48173F", indexed_at: 1724134080000}]->(p);
MATCH (u:User {id: $Wobly}), (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) MERGE (u)-[:TAGGED {label: $go_post_tag, id: "1TDVFKFBB48G", indexed_at: 1724134092000}]->(p);
MATCH (u:User {id: $anonymous}), (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) MERGE (u)-[:TAGGED {label: $go_post_tag, id: "2VDW8YBDZJ02", indexed_at: 1724334095000}]->(p);
MATCH (u:User {id: $nakamoto}), (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "ERDW8ZSNPR4G", indexed_at: 1724134080000}]->(p);
MATCH (u:User {id: $Wobly}), (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "FTDW8ZSQNL9Y", indexed_at: 1724134092000}]->(p);
MATCH (u:User {id: $anonymous}), (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "GRDW8ZSRMPC1", indexed_at: 1724334095000}]->(p);
MATCH (u:User {id: $arst}), (p:Post {id: "HC3T5CEPBPHQ", author_id: $peter}) MERGE (u)-[:TAGGED {label: $defend_post_tag, id: "HTDX9ZSTNQ47", indexed_at: 1724334095000}]->(p);


MERGE (p2:Post {id: "1TDV7XBCF4M1", author_id: $anonymous}) SET p2.content = "Freedom of speech is essential for democracy", p2.kind = "short", p2.indexed_at = 1719308316921;
MATCH (u2:User {id: $anonymous}), (p2:Post {id: "1TDV7XBCF4M1", author_id: $anonymous}) MERGE (u2)-[:AUTHORED]->(p2);
MATCH (u:User {id: $arst}), (p:Post {id: "1TDV7XBCF4M1", author_id: $anonymous}) MERGE (u)-[:TAGGED {label:$privacy_post_tag, id: "1RDV7ZX9BX93", indexed_at: 1724544095000}]->(p);
MATCH (u:User {id: $nakamoto}), (p:Post {id: "1TDV7XBCF4M1", author_id: $anonymous}) MERGE (u)-[:TAGGED {label: $privacy_post_tag, id: "2TDW8YKH56JN", indexed_at: 1724134080000}]->(p);
MATCH (u:User {id: $Wobly}), (p:Post {id: "1TDV7XBCF4M1", author_id: $anonymous}) MERGE (u)-[:TAGGED {label: $human_right_post_tag, id: "3VDX9ZM7C4P1", indexed_at: 1724134092000}]->(p);
MATCH (u:User {id: $Wobly}), (p:Post {id: "1TDV7XBCF4M1", author_id: $anonymous}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "3VDX9ZM7C4P5", indexed_at: 1724134096000}]->(p);

MERGE (p3:Post {id: "2VDW8YBDZJ02", author_id: $anonymous}) SET p3.content = "Decentralization is key to preserving freedom", p3.kind = "short", p3.indexed_at = 1719308318234;
MATCH (u3:User {id: $anonymous}), (p3:Post {id: "2VDW8YBDZJ02", author_id: $anonymous}) MERGE (u3)-[:AUTHORED]->(p3);
MATCH (u:User {id: $nakamoto}), (p:Post {id: "2VDW8YBDZJ02", author_id: $anonymous}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "4SDW8YPKDL2M", indexed_at: 1724134080000}]->(p);
MATCH (u:User {id: $Wobly}), (p:Post {id: "2VDW8YBDZJ02", author_id: $anonymous}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "6TDW8ZMHJF29", indexed_at: 1724134092000}]->(p);
MATCH (u:User {id: $peter}), (p:Post {id: "2VDW8YBDZJ02", author_id: $anonymous}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "7VDW8ZRJKN3Y", indexed_at: 1724134092000}]->(p);
MATCH (u:User {id: $peter}), (p:Post {id: "2VDW8YBDZJ02", author_id: $anonymous}) MERGE (u)-[:TAGGED {label: $human_right_post_tag, id: "8SDX8YQMKP19", indexed_at: 1724134092000}]->(p);
MATCH (u:User {id: $peter}), (p:Post {id: "2VDW8YBDZJ02", author_id: $anonymous}) MERGE (u)-[:BOOKMARKED {id: "2Z9PFGC3WWWT0", indexed_at: 1721764200000}]->(p);
