...
MATCH (u:User {id: $peter}), (p:Post {id: "HC3T5CEPBPHQQ"}) MERGE (u)-[:AUTHORED]->(p);
MATCH (u:User {id: $arst}), (p:Post {id: "HC3T5CEPBPHQQ"}) MERGE (u)-[:TAGGED {label: $go_post_tag, id: "0RDVNJ0XR560", indexed_at: 1724544095000}]->(p);
MATCH (u:User {id: $nakamoto}), (p:Post {id: "HC3T5CEPBPHQQ"}) MERGE (u)-[:TAGGED {label: $go_post_tag, id: "S02JBP48173F", indexed_at: 1724134080000}]->(p);
MATCH (u:User {id: $Wobly}), (p:Post {id: "HC3T5CEPBPHQQ"}) MERGE (u)-[:TAGGED {label: $go_post_tag, id: "1TDVFKFBB48G", indexed_at: 1724134092000}]->(p);
MATCH (u:User {id: $anonymous}), (p:Post {id: "HC3T5CEPBPHQQ"}) MERGE (u)-[:TAGGED {label: $go_post_tag, id: "2VDW8YBDZJ02", indexed_at: 1724334095000}]->(p);
MATCH (u:User {id: $nakamoto}), (p:Post {id: "HC3T5CEPBPHQQ"}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "ERDW8ZSNPR4G", indexed_at: 1724134080000}]->(p);
MATCH (u:User {id: $Wobly}), (p:Post {id: "HC3T5CEPBPHQQ"}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "FTDW8ZSQNL9Y", indexed_at: 1724134092000}]->(p);
MATCH (u:User {id: $anonymous}), (p:Post {id: "HC3T5CEPBPHQQ"}) MERGE (u)-[:TAGGED {label: $free_post_tag, id: "GRDW8ZSRMPC1", indexed_at: 1724334095000}]->(p);
MATCH (u:User {id: $arst}), (p:Post {id: "HC3T5CEPBPHQQ"}) MERGE (u)-[:TAGGED {label: $defend_post_tag, id: "HTDX9ZSTNQ47", indexed_at: 1724334095000}]->(p);
