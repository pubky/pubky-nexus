...
pub const SEARCH_TAGS_BY_PREFIX_ROUTE_BASE: &str = concatcp!(SEARCH_PREFIX, "/tags/by_prefix");
pub const SEARCH_TAGS_BY_PREFIX_ROUTE: &str =
    concatcp!(SEARCH_TAGS_BY_PREFIX_ROUTE_BASE, "/{prefix}");
