...
pub struct BootstrapIds {
    ...
    /// DEPRECATED: Always empty. Muted users are now managed client-side.
    /// This field will be removed in a future release.
    #[deprecated(
        note = "Muted users are now managed client-side. This field is always empty and will be removed."
    )]
