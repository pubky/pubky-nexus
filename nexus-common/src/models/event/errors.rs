...
#[error("hs_id={hs_id}, expected={expected_user_id}, received={received_user_id}")]
pub struct UserIdMismatch {
    pub hs_id: String,
    pub expected_user_id: String,
    pub received_user_id: String,
}
...
pub enum EventProcessorError {
    ...
    #[error("Homeserver returned an event for different user than expected: {0}")]
