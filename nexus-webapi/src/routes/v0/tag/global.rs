...
#[utoipa::path(
    ...
    params(
        ...
        ("skip" = Option<BoundedSkip<10_000>>, Query, description = "Skip N taggers. Defaults to `0`"),
...
#[utoipa::path(
    ...
    params(
        ...
        ("skip" = Option<BoundedSkip<10_000>>, Query, description = "Skip N tags. Defaults to `0`"),
