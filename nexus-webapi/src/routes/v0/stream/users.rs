...
#[utoipa::path(
    ...
    params(
        ...
        ("reach" = Option<StreamReach>, Query, description = "The target reach of the 'influencers' source: `followers` | `following` | `friends` | `wot` | `wot_1`..`wot_3`. Bare `wot` defaults to depth 3."),
