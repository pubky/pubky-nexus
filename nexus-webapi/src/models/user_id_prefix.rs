...
mod tests {
    ...
    #[test]
    fn validate_exact_min_length() {
        assert!(UserIdPrefix::validate("abc").is_ok());
    }

    #[test]
    fn validate_above_min_length() {
    ...
    #[test]
    fn validate_unicode_chars() {
        // Unicode chars are counted by .chars(), not bytes
        assert!(UserIdPrefix::validate("🔥🔥🔥").is_ok());
    }

    #[test]
    fn validate_unicode_chars_too_short() {
        assert!(UserIdPrefix::validate("🔥🔥").is_err());
    }

    #[test]
    fn validate_error_message_contains_min_length() {
    ...
    #[test]
    fn try_from_string_failure_too_short() {
    ...
    #[test]
    fn try_from_rejects_whitespace_padded_too_short() {
